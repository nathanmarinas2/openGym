...
const COPY = {
  en: {
    title: 'Daily briefing', subtitle: 'One view for today’s training, fuel and recovery.', training: 'Training today', planned: 'Planned', completed: 'Completed', rest: 'Rest day', volume: 'Volume', sets: 'sets', effort: 'Effort', rests: 'Rest', nutrition: 'Fuel remaining', calories: 'Calories', protein: 'Protein', hydration: 'Hydration', fasting: 'Fasting', active: 'Active', inactive: 'Not active', body: 'Body trend', noWeight: 'No weight logged', recommendation: 'One useful next step', openWorkout: 'Open workout', openNutrition: 'Open nutrition', openProgress: 'Review progress', openCoach: 'Review coach', logWater: 'Log water', back: 'Home', noPlan: 'No session planned' },
  es: {
    title: 'Resumen diario', subtitle: 'Una vista para el entrenamiento, la nutrición y la recuperación de hoy.', training: 'Entrenamiento de hoy', planned: 'Planificado', completed: 'Completado', rest: 'Día de descanso', volume: 'Volumen', sets: 'series', effort: 'Esfuerzo', rests: 'Descanso', nutrition: 'Combustible restante', calories: 'Calorías', protein: 'Proteína', hydration: 'Hidratación', fasting: 'Ayuno', active: 'Activo', inactive: 'No activo', body: 'Tendencia corporal', noWeight: 'No hay peso registrado', recommendation: 'Siguiente paso útil', openWorkout: 'Abrir entrenamiento', openNutrition: 'Abrir nutrición', openProgress: 'Ver progreso', openCoach: 'Ver coach', logWater: 'Registrar agua', back: 'Inicio', noPlan: 'No hay sesión planificada' }
}
