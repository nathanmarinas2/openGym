...
export default {
  ...
  "This browser doesn't support passkeys — you can still use LiftNex locally on this device.": 'यह ब्राउज़र पासकी सपोर्ट नहीं करता — फिर भी आप इस डिवाइस पर LiftNex लोकली इस्तेमाल कर सकते हैं।',
  ...
  'Exercise transition rest': 'व्यायाम के बीच आराम', 'Rest between sets': 'सेट के बीच आराम', 'Rest between exercises': 'व्यायाम के बीच आराम', 'Rest tracked': 'आराम दर्ज', 'Average rest': 'औसत आराम', 'remaining': 'बाकी', 'Add a short walk': 'थोड़ी देर टहलें',
  'Sounds': 'ध्वनियाँ',
  ...
  'to install LiftNex as a full-screen app.': 'से LiftNex को फुल-स्क्रीन ऐप के रूप में इंस्टॉल करें।',
  ...
  'Rest-timer alerts, even if LiftNex is closed.': 'आराम टाइमर अलर्ट, LiftNex बंद होने पर भी।',
  ...
  'A small file a friend imports into their own LiftNex — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने LiftNex में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  'Reload LiftNex': 'LiftNex फिर से लोड करें',
