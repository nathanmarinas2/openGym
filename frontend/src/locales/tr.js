...
export default {
  ...
  "This browser doesn't support passkeys — you can still use LiftNex locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de LiftNex’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install LiftNex as a full-screen app.': 'ile LiftNex’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if LiftNex is closed.': 'LiftNex kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own LiftNex — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi LiftNex\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
