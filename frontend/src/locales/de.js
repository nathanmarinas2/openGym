...
export default {
  ...
  "This browser doesn't support passkeys — you can still use LiftNex locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst LiftNex trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'Exercise transition rest': 'Pause zwischen Übungen', 'Rest between sets': 'Pause zwischen Sätzen', 'Rest between exercises': 'Pause zwischen Übungen', 'Rest tracked': 'Pausen erfasst', 'Average rest': 'Durchschnittliche Pause', 'remaining': 'verbleibend', 'Add a short walk': 'Kurzen Spaziergang hinzufügen',
  'Sounds': 'Töne',
  ...
  'to install LiftNex as a full-screen app.': 'um LiftNex als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if LiftNex is closed.': 'Pausen-Timer-Alarm, auch wenn LiftNex geschlossen ist.',
  ...
  'A small file a friend imports into their own LiftNex — routines only, none of your workouts or weigh-ins.': 'Eine kleine Datei, die ein Freund in sein eigenes LiftNex importiert — nur Routinen, keine Workouts oder Wiegungen.',
  ...
  'Reload LiftNex': 'LiftNex neu laden',
