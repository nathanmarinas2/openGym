...
export default {
  ...
  "This browser doesn't support passkeys — you can still use LiftNex locally on this device.": '此浏览器不支持通行密钥——你仍可在本设备上本地使用 LiftNex。',
  ...
  'Weight unit': '重量单位',
  'Rest timer': '休息计时',
  'Exercise transition rest': '动作间休息', 'Rest between sets': '组间休息', 'Rest between exercises': '动作间休息', 'Rest tracked': '已记录休息', 'Average rest': '平均休息', 'remaining': '剩余', 'Add a short walk': '短走一会儿',
  'Sounds': '声音',
  ...
  'to install LiftNex as a full-screen app.': '即可将 LiftNex 安装为全屏应用。',
  ...
  'Rest-timer alerts, even if LiftNex is closed.': '休息计时提醒，即使 LiftNex 已关闭。',
  ...
  'A small file a friend imports into their own LiftNex — routines only, none of your workouts or weigh-ins.': '一个小文件，朋友可以导入到自己的 LiftNex——只有训练日，不包含你的训练记录或体重。',
