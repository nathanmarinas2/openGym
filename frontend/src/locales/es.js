...
export default {
  ...
  "This browser doesn't support passkeys — you can still use LiftNex locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar LiftNex localmente en este dispositivo.',
  ...
  'Exercise transition rest': 'Descanso entre ejercicios',
  'Rest between sets': 'Descanso entre series',
  'Rest between exercises': 'Descanso entre ejercicios',
  'Rest tracked': 'Descansos registrados',
  'Average rest': 'Descanso medio',
  'remaining': 'restantes',
  'Add a short walk': 'Añade un paseo corto',
  'Sounds': 'Sonidos',
  ...
  'to install LiftNex as a full-screen app.': 'para instalar LiftNex como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if LiftNex is closed.': 'Avisos del temporizador de descanso, incluso con LiftNex cerrado.',
  ...
  'A small file a friend imports into their own LiftNex — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio LiftNex: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Reload LiftNex': 'Recargar LiftNex',
