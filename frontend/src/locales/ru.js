...
export default {
  ...
  "This browser doesn't support passkeys — you can still use LiftNex locally on this device.": 'Этот браузер не поддерживает ключи доступа — но LiftNex можно использовать локально на этом устройстве.',
  ...
  'to install LiftNex as a full-screen app.': 'чтобы установить LiftNex как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if LiftNex is closed.': 'Оповещения таймера отдыха, даже если LiftNex закрыт.',
  ...
  'A small file a friend imports into their own LiftNex — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой LiftNex — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload LiftNex': 'Перезагрузить LiftNex',
