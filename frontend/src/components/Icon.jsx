...
const P = {
  ...
  droplet: <path d="M12 3.5C9.2 7.1 6.4 10.3 6.4 14a5.6 5.6 0 0 0 11.2 0c0-3.7-2.8-6.9-5.6-10.5Z" />,
  ...
  /* ---- actions ---- */
  barcode: <><path d="M4 5.2v13.6M7 5.2v13.6M10 5.2v13.6M14 5.2v13.6M17 5.2v13.6M20 5.2v13.6" /><path d="M4 3.6v1.6M20 3.6v1.6M4 18.8v1.6M20 18.8v1.6" /></>,
  forkKnife: <><path d="M6.2 3.5v6.2M4.2 3.5v3.8a2 2 0 0 0 4 0V3.5M6.2 9.4v11.1" /><path d="M15.9 3.5c-2.2 2.4-2.5 5.1-.2 7.2l1.5 1.3v8.5M15.9 3.5v8.5M18.3 3.5v8.5" /></>,
  footprints: <><path d="M8.1 5.1c1.6.4 2.4 2.1 2 3.9-.4 1.8-1.7 3.1-3.2 2.7-1.6-.4-2.2-2.2-1.8-4 .4-1.8 1.5-3 3-2.6Z" /><path d="M15.9 12.3c1.6.4 2.4 2.1 2 3.9-.4 1.8-1.7 3.1-3.2 2.7-1.6-.4-2.2-2.2-1.8-4 .4-1.8 1.5-3 3-2.6Z" /><path d="M8.4 14.2c-.9 1.7-1 3.4.2 4.5M15.5 5.2c.9 1.1 1.1 2.8.6 4.2" /></>,
  brain: <><path d="M9.4 5.1a3.1 3.1 0 0 0-5.2 2.3 3.1 3.1 0 0 0 .4 1.5 3.6 3.6 0 0 0 .6 6.3 3.2 3.2 0 0 0 4.2 3.1 2.8 2.8 0 0 0 2.6 1.5" /><path d="M14.6 5.1a3.1 3.1 0 0 1 5.2 2.3 3.1 3.1 0 0 1-.4 1.5 3.6 3.6 0 0 1-.6 6.3 3.2 3.2 0 0 1-4.2 3.1 2.8 2.8 0 0 1-2.6 1.5M12 4.2v15.6M8.6 8.4h2M13.4 11.1h2M8.8 14.3h2M13.2 16.2h2" /></>,
  dashboard: <><path d="M4.1 15.8a8.2 8.2 0 1 1 15.8 0" /><path d="m12 12 4-3.5M5.2 18.8h13.6" /><path d="M7.1 8.1h.01M16.9 8.1h.01" /></>,
  image: <><rect x="4" y="4.4" width="16" height="15.2" rx="2.4" /><circle cx="9" cy="9" r="1.4" /><path d="m5.6 17 4.2-4.1 3.1 2.7 2.2-2.1 3.3 3.5" /></>,
  camera: <><path d="M5.2 8.2h2.4l1.3-2.1h6.2l1.3 2.1h2.4a1.8 1.8 0 0 1 1.8 1.8v7.2a1.8 1.8 0 0 1-1.8 1.8H5.2a1.8 1.8 0 0 1-1.8-1.8V10a1.8 1.8 0 0 1 1.8-1.8Z" /><circle cx="12" cy="13.4" r="3.1" /></>,
  ...
  box: <><path d="m4.2 7.5 7.8-4 7.8 4v9l-7.8 4-7.8-4Z" /><path d="m4.2 7.5 7.8 4 7.8-4M12 11.5v9" /></>,
